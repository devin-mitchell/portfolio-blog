        ...
        imageAlignRight ?
          ...
          <>
            <div className="sticky top-0 flex flex-col md:w-1/2 px-4 h-full w-full">
              <h2 className="animate-fadeInUp text-5xl md:text-8xl font-bold tracking-tighter leading-tight md:pr-8">
                {header}
              </h2>
            ...
            <div className="w-full">
              <div className="w-full h-screen relative flex flex-col items-start">
                <Image alt={imageAlt} fill className={`object-cover object-[${imageDisplacement || '55'}%]`} src={imageSrc} />
              </div>
            </div>
          </>
